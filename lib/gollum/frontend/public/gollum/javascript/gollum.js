...
$(document).ready(function() {
  ...
  $('#delete-link').click( function(e) {
    ...
    if ( ok ) {
      ...
      loc = baseUrl +'/'+repo+'/delete' + loc.pathname.replace(baseUrl+'/'+repo,'');
      window.location = loc;
    }
    ...
    $('#minibutton-rename-page').click(function(e) {
      ...
      $.GollumDialog.init({
        ...
        OK: function( res ) {
          ...
          jQuery.ajax( {
            type: 'POST',
            url: baseUrl + '/' + repo + '/edit/' + oldName,
            data:  { path: path, rename: newName, page: oldName, message: msg },
            success: function() {
                window.location = baseUrl +'/'+repo + '/' + encodeURIComponent(newName);
            }
          });
        }
      });
    ...
    $('#minibutton-new-page').click(function(e) {
      ...
      $.GollumDialog.init({
        ...
        OK: function( res ) {
          ...
          window.location = baseUrl +'/'+ repo + '/' + encodeURIComponent(name);
        }
      });
    });
  }
